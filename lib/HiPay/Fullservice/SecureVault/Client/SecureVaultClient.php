...
class SecureVaultClient implements SecureVaultClientInterface
{
     ...
     */
    const ENDPOINT_GENERATE_TOKEN = 'v1/token/create';
     ...
     */
    const ENDPOINT_UPDATE_TOKEN = 'v1/token/update';
     ...
     */
    const ENDPOINT_LOOKUP_TOKEN = 'v1/token/{token}';
    ...
    public function requestGenerateToken(GenerateTokenRequest $generateTokenRequest)
    {
        ...
        $response = $this->getClientProvider()->request(
            self::METHOD_GENERATE_TOKEN,
            self::ENDPOINT_GENERATE_TOKEN,
            $params,
            true
        );
    ...
    public function requestUpdateToken(UpdateTokenRequest $updateTokenRequest)
    {
        ...
        //send request
        $response = $this->getClientProvider()->request(
            self::METHOD_UPDATE_TOKEN,
            self::ENDPOINT_UPDATE_TOKEN,
            $params,
            true
        );
